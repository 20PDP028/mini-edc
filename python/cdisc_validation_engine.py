        ...
        for rec in records:
            ...
            if self._is_missing(rec.get("RFSTDTC")):
                self._add(
                    ...
                    "RFSTDTC",
                    None,
                    "Reference start date (RFSTDTC) missing",
                    Severity.MAJOR,
                )
            ...
            if ethnic and ethnic not in CDISC_CT["ETHNIC"]:
                self._add(
                    ...
                    "ETHNIC",
                    ethnic,
                    f"ETHNIC '{ethnic}' not in CDISC CT",
                    Severity.MINOR,
                )
        ...
        for rec in records:
            ...
            if outcome and outcome not in CDISC_CT["AEOUT"]:
                self._add(
                    ...
                    "AEOUT",
                    outcome,
                    f"AEOUT '{outcome}' not in CDISC CT",
                    Severity.MAJOR,
                    visit,
                    seq,
                )
        ...
        for rec in records:
            ...
            if self._is_missing(test):
                self._add(
                    ...
                    "LBTESTCD",
                    None,
                    "Lab test code (LBTESTCD) missing",
                    Severity.CRITICAL,
                    visit,
                    seq,
                )
            ...
            if nrind and nrind not in {
                "NORMAL",
                "LOW",
                "HIGH",
                "CRITICALLY LOW",
                "CRITICALLY HIGH",
                "NORMAL AFTER PANIC LOW",
            ...
            if not self._is_missing(rec.get("LBORRES")) and self._is_missing(
                rec.get("LBSTRESU")
            ):
                self._add(
                    "LB06",
        ...
        for rec in records:
            ...
            if not ex_start:
                self._add(
                    ...
                    "EXSTDTC",
                    rec.get("EXSTDTC"),
                    "Exposure start date (EXSTDTC) missing",
                    Severity.CRITICAL,
                    visit,
                    seq,
                )
            ...
            if self._is_missing(rec.get("EXDOSFRQ")):
                self._add(
                    ...
                    "EXDOSFRQ",
                    None,
                    "Dose frequency (EXDOSFRQ) missing",
                    Severity.MINOR,
                    visit,
                    seq,
                )
        ...
        for rec in records:
            ...
            if not svstdtc:
                self._add(
                    ...
                    "SVSTDTC",
                    rec.get("SVSTDTC"),
                    "Visit start date (SVSTDTC) missing",
                    Severity.MAJOR,
                    visit,
                )
        ...
        for rec in records:
            ...
            if dsdecod and dsdecod not in CDISC_CT["DSDECOD"]:
                self._add(
                    ...
                    "DSDECOD",
                    dsdecod,
                    f"DSDECOD '{dsdecod}' not in CDISC CT",
                    Severity.MAJOR,
                )
            ...
            if self._is_missing(rec.get("DSSTDTC")):
                self._add(
                    ...
                    "DSSTDTC",
                    None,
                    "Disposition date (DSSTDTC) missing",
                    Severity.MAJOR,
                )
...
SAMPLE_DATA = {
    "DM": [
        ...
        },
        {
            ...
            "ARM": "PLACEBO",
            "RFICDTC": "2024-01-20",
            "RFSTDTC": "2024-01-18",  # ← Bad: consent AFTER start
            "RFENDTC": "2024-07-18",
        },
        {
            "USUBJID": "STUDY001-002-001",
            "SITEID": "002",
            "SEX": "F",
    ...
    "AE": [
        {
            ...
            "AESEQ": 1,
            "AETERM": "Headache",
            "AEDECOD": "Headache",  # ← Minor: coded = verbatim
            "AESTDTC": "2024-02-10",
            "AEENDTC": "2024-02-08",  # ← Bad: end before start
            "AESEV": "MILD",
        ...
        },
        {
            ...
            "AESDISAB": "N",
            "AESLIFE": "N",
            "AESMIE": "N",  # ← Bad: no SAE criteria met
    ...
    "VS": [
        ...
        },
        {
            ...
            "VSSEQ": 1,
            "VSTESTCD": "PULSE",
            "VSORRES": 250,  # ← Bad: impossible pulse
            "VSORRESU": "beats/min",
            "VSDTC": "2024-02-05",
            "VISIT": "BASELINE",
        },
        {
            ...
            "VSSEQ": 1,
            "VSTESTCD": "WEIGHT",
            "VSORRES": "seventy",  # ← Bad: not numeric
            "VSORRESU": "kg",
            "VSDTC": "2024-01-18",
            "VISIT": "BASELINE",
        },
...
if __name__ == "__main__":
    ...
    for f in findings:
        ...
        print(
            f"{icon} [{f['rule_id']}] {f['domain']} | {f['subject_id']} | "
