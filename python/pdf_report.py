...
def _styles():
    ...
    return {
        ...
        "body": ParagraphStyle(
            "body", fontSize=9, fontName="Helvetica", leading=13, spaceAfter=3
        ),
        "small": ParagraphStyle(
            "small", fontSize=7.5, fontName="Helvetica", textColor=colors.grey
        ),
        ...
        "critical": ParagraphStyle(
            "critical", fontSize=9, textColor=RED, fontName="Helvetica-Bold"
        ),
        "major": ParagraphStyle(
            "major", fontSize=9, textColor=AMBER, fontName="Helvetica-Bold"
        ),
    }
...
def generate_pdf(
    ...
    story.append(
        _kpi_row(
            [
                ...
                (
                    "Pending Report",
                    sum(1 for s in saes if s.get("report_flag") == "PENDING"),
                    AMBER,
                ),
                ...
                (
                    "Sites",
                    len({q.get("siteid") for q in queries}),
    ...
    if queries:
        ...
        story.append(Spacer(1, 8))
        story.append(
            Paragraph(f"Answered / Closed Queries ({len(other_list)})", s["h2"])
        )
        if other_list:
...
if __name__ == "__main__":
    ...
    sample_audit = [
        {
            "event_time": "2024-11-20 09:01:00",
            "action": "QUERY_OPEN",
            "table_name": "queries",
            "record_id": "QRY-0001",
            "field": "status",
        ...
        {
            "event_time": "2024-11-21 14:30:00",
            "action": "QUERY_ANSWER",
            "table_name": "queries",
            "record_id": "QRY-0001",
            "field": "status",
        ...
        {
            "event_time": "2024-11-22 10:00:00",
            "action": "QUERY_CLOSE",
            "table_name": "queries",
            "record_id": "QRY-0001",
            "field": "status",
        ...
        {
            "event_time": "2024-11-20 09:01:05",
            "action": "SAE_FLAG",
            "table_name": "adverse_events",
            "record_id": "SUB010",
            "field": "AESER",
            "old_value": None,
            "new_value": "Anaphylaxis",
            "performed_by": "SYSTEM",
        },
    ]
    generate_pdf(
